      ...
      <div className={styles.marketingSection}>
        <div className={styles.featuresGrid}>
          <div className={styles.featureCard}>
            ...
            <p className={styles.featureText}>
              KKCC is one of the premier Computer educational institute
              dedicated to impart quality education and promoting excellence in
              academic pursuits in the filed of Software Training and
              Developing.
            </p>
          ...
          <div className={styles.featureCard}>
            ...
            <p className={styles.featureText}>
              KKCC has a full-fledged Hardware and Network Training and
              placement for right students and we are proud to say that we have
              done Institute placements with many Hardware and Networking
              Servicing Center.
            </p>
          ...
          <div className={styles.featureCard}>
            ...
            <p className={styles.featureText}>
              KKCC has a Developed live projects and also provide project(
              Computers Science ) training for Engineering, Degree, PG studied
              studetns or completed students.This institute can also training
              projects from scrach to advance
            </p>
            <Link href="/about" className={styles.featureButton}>
              View details &raquo;
            </Link>
        ...
        <div className={styles.aboutSection}>
          <div className={styles.aboutContent}>
            <h2 className={styles.aboutTitle}>About KKCC</h2>

            ...
            <div className={styles.mobileDropdownInner}>
              ...
              <div className="mt-4 pb-2 px-3">
                <Link
                  href="/training"
                  onClick={() => setIsOpen(false)}
                  className="w-full inline-flex justify-center items-center text-white bg-blue-600 hover:bg-blue-700 px-4 py-2.5 rounded-md text-base font-medium transition-colors"
                >
                  Explore Courses
                </Link>
              </div>

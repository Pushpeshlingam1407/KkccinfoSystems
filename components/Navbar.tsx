          ...
          <div className={styles.mobileDropdown}>
            <div className={styles.mobileDropdownInner}>
              ...
              <div className="border-t border-slate-700 pt-2 pb-1 mt-2">
                <span className="block px-3 py-2 text-xs font-bold text-slate-400 uppercase tracking-widest">Interview Q&A</span>
                ...
                <Link href="/interview-qa?tech=react"      onClick={() => setIsOpen(false)} className={styles.mobileNavLink}>― React JS</Link>
              ...
              <div className="border-t border-slate-700 pt-2 pb-1 mt-2">
                <span className="block px-3 py-2 text-xs font-bold text-slate-400 uppercase tracking-widest">Code Snippets</span>
